    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-6">
        <form action="{{ url('products/update') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <x-text-input id="name" class="block mt-2 w-full" type="text" name="name" :value="$product->name"
                    required />
            ...
            <div>
                ...
                <x-text-input id="quantity" class="block mt-2 w-full" type="number" name="quantity"
            ...
            <div>
                ...
                <x-text-input id="price" class="block mt-2 w-full" type="number" name="price" :value="$product->price"
                    required />
            ...
            <div>
                ...
                <select id="destaque" name="destaque"
                    ...
                    <option value="0" @if(old('destaque', $product->destaque) == '0') selected @endif>Não</option>
                    <option value="1" @if(old('destaque', $product->destaque) == '1') selected @endif>Sim</option>
                </select>
