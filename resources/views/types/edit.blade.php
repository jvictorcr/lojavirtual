<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-6">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 leading-tight">Editar Tipo</h2>
        ...
        <form method="POST" action="{{ url('/type/update') }}">
            ...
            <div class="mt-4">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $type->name) }}" required class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-500 dark:text-gray-300">
            </div>
